...
structure = {
    project_name : {'presentation': ['controller.py', 'cli_interface.py', 'api_routes.py'],
                    'business': ['service.py'],
                    'data': ['repository.py'],
                    'domian': ['entity.py', 'repository_interface.py'],
                    'infrastructure': ['db_connection.py', 'api_client.py', 'settings.py'],
                    }
}
