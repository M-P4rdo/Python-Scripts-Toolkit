...
structure = {
    project_name : {'application': ['create_entity.py', 'interfaces.py'],
                    'domain': ['entity.py', 'exceptions.py'],
                    'adapters': {'web' : ['routes.py', 'controllers.py', 'serializers.py'],
                                 'persistence': ['repository.py', 'db_connection.py']},
                    'config': ['settings.py', 'container.py']
                    }
}
