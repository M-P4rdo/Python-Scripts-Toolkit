...
base_files = ["main.py", "README.md", ".env", "requirements.txt", "App.jsx"]

structure = {
    project_name : {'components': ['Navbar.jsx', 'InputField.jsx'],
                    'views': ['Home.jsx', 'Login.jsx', 'Dashboard.jsx'],
                    'store': ['modelSlice.js'],
                    'services': ['authService.js', 'modelService.js', 'axiosConfig.js'],
                    'assets': ['fonts/', 'icons/'],
                    'router' : ['index.js']
                    }
}
